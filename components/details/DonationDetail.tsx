...
export default function DonationDetail({ detail }: DonationDetailProps) {
    let amounts = detail.data.txs.sort((a: { timeStamp: string }, b: { timeStamp: string }) => {
        ...
        <div className="flex flex-col items-start justify-start gap-5 filter">
            <section className="w-full">
                ...
                <div
                    ...
                    onClick={() => {
                        window.open(detail.reference_url);
                    }}
                >
                    <BiLinkAlt />
            ...
            <div>
                ...
                <p className="line-clamp-5">{detail.description || 'No information provided by Gitcoin.'}</p>
            </div>
